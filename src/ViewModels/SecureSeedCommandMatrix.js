...
function getLinuxTRDescription(startChar, endChar, startNum, endNum) {
  return `<code>tr -dc ${startChar}-${endChar}${startNum}-${endNum} |</code> filters the random numbers to consist of the set of characters "A" through "Z" and "0" through "9". Then this gets piped to the next command.`
}
